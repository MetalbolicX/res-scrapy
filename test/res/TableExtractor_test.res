...
test("TableExtractor extracts rows using thead headers and tbody rows", () => {
  let html = "<table class='products'><thead><tr><th>Name</th><th>Price</th></tr></thead><tbody><tr><td>A</td><td>10</td></tr><tr><td>B</td><td>20</td></tr></tbody></table>"
...
test("TableExtractor falls back to first tr headers when thead is missing", () => {
  let html = "<table><tr><th>Name</th><th>Price</th></tr><tr><td>A</td><td>10</td></tr><tr><td>B</td><td>20</td></tr></table>"
  switch run(~html) {
  | Ok(rows) =>
    isTextEqualTo(
      "[{\"Name\":\"A\",\"Price\":\"10\"},{\"Name\":\"B\",\"Price\":\"20\"}]",
...
test("TableExtractor fills missing cells with empty string", () => {
  let html = "<table><thead><tr><th>Name</th><th>Price</th><th>Stock</th></tr></thead><tbody><tr><td>A</td><td>10</td></tr></tbody></table>"
  switch run(~html) {
  | Ok(rows) =>
    isTextEqualTo(
...
test("TableExtractor treats rowspan as a single plain cell", () => {
  let html = "<table><thead><tr><th>Name</th><th>Price</th></tr></thead><tbody><tr><td rowspan=\"2\">tall</td><td>10</td></tr><tr><td>20</td></tr></tbody></table>"
  switch run(~html) {
  | Ok(rows) =>
    isTextEqualTo(
