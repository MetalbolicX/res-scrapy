...
| `code-health-audit` | Trigger: audit code health, architecture, god files, or structural smells. Explore source first, report prioritized findings, and refactor only when requested. | user | `/home/metalbolicx/.claude/skills/code-health-audit/SKILL.md` |
